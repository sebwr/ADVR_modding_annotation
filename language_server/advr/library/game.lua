...
--- @return void
function game.add_GameHandlerInitialized(value) end

--- [WIP] - No method annotation provided
--- @param value OnGameHandlerInitialized [WIP] - Add description for parameter
--- @return void
function game.remove_GameHandlerInitialized(value) end

--- [WIP] - No method annotation provided
--- @param value OnPlayerReferenceSet [WIP] - Add description for parameter
--- @return void
function game.add_PlayerReferenceSet(value) end

--- [WIP] - No method annotation provided
--- @param value OnPlayerReferenceSet [WIP] - Add description for parameter
--- @return void
function game.remove_PlayerReferenceSet(value) end

--- [WIP] - No method annotation provided
--- @param value OnObjectsSpawned [WIP] - Add description for parameter
--- @return void
function game.add_ObjectSpawned(value) end

--- [WIP] - No method annotation provided
--- @param value OnObjectsSpawned [WIP] - Add description for parameter
--- @return void
function game.remove_ObjectSpawned(value) end
