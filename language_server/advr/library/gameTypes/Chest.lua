...
--- @class Chest
--- @field spawnParent Transform [WIP] - No field annotation provided 
--- @field openSound ADSoundEffect [WIP] - No field annotation provided 
--- @field correspondingLock Lock [WIP] - No field annotation provided 
--- @field dropTable string [WIP] - No field annotation provided 
--- @field itemToSpawn GameObject [WIP] - No field annotation provided 
--- @field newItemParticles ParticleSystem [WIP] - No field annotation provided 
