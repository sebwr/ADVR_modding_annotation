...
--- @class AIHumanoidAttack
--- @field attackInfos AttackInfos[] [WIP] - No field annotation provided 
--- @field enemySword EnemySword [WIP] - No field annotation provided 
--- @field parryDoesBulletTime boolean [WIP] - No field annotation provided 
--- @field onlyDamageWhenParried boolean [WIP] - No field annotation provided 
--- @field ik AimIK [WIP] - No field annotation provided 
--- @field animatedSwingDirection Vector3 [WIP] - No field annotation provided 
--- @field stepSound ADSoundEffect [WIP] - No field annotation provided 
--- @field attackSound ADSoundEffect [WIP] - No field annotation provided 
--- @field parryHint GameObject [WIP] - No field annotation provided 
