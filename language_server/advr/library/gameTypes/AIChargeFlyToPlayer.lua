...
--- @class AIChargeFlyToPlayer
--- @field chargeSpeed number [WIP] - No field annotation provided 
--- @field timeToChargeUp number [WIP] - No field annotation provided 
--- @field chargeSound ADSoundEffect [WIP] - No field annotation provided 
--- @field letGoSound ADSoundEffect [WIP] - No field annotation provided 
--- @field chargeParticles ParticleSystem [WIP] - No field annotation provided 
--- @field forwardMode FORWARD_MODE [WIP] - No field annotation provided 
