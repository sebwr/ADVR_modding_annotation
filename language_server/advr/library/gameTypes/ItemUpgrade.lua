...
--- @class ItemUpgrade
--- @field pickupSound string [WIP] - No field annotation provided 
--- @field pickupParticles GameObject [WIP] - No field annotation provided 
--- @field spawnPool string [WIP] - No field annotation provided 
--- @field forceSpawn string [WIP] - No field annotation provided 
--- @field forceTier integer [WIP] - No field annotation provided 
--- @field _moddingForceSpawn PickupDiskRepresentation [WIP] - No field annotation provided 
--- @field rolledItem PickupDiskRepresentation [WIP] - No field annotation provided 
