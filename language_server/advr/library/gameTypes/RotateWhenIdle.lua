...
--- @class RotateWhenIdle
--- @field shouldRotate boolean [WIP] - No field annotation provided 
--- @field rotateDir Vector3 [WIP] - No field annotation provided 
--- @field shouldMoveUpDown boolean [WIP] - No field annotation provided 
--- @field upDownAmount Vector3 [WIP] - No field annotation provided 
--- @field restartScriptOnLowVelocity boolean [WIP] - No field annotation provided 
RotateWhenIdle = {}
