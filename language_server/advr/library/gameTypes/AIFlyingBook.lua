...
--- @field shootDelay number [WIP] - No field annotation provided 
--- @field bulletSpeed number [WIP] - No field annotation provided 
--- @field shootPos Transform [WIP] - No field annotation provided 
--- @field projectileVis Transform [WIP] - No field annotation provided 
--- @field projectilesToShootAtOnce integer [WIP] - No field annotation provided 
--- @field projectileDegrees number [WIP] - No field annotation provided 
--- @field xProjectileDegrees number [WIP] - No field annotation provided 
--- @field shootingSound ADSoundEffect [WIP] - No field annotation provided 
