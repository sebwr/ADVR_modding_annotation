...
--- @field spawnBulletForScaleAnim boolean [WIP] - No field annotation provided 
--- @field projectileParent Transform [WIP] - No field annotation provided 
--- @field shootSound ADSoundEffect [WIP] - No field annotation provided 
--- @field ignoreYOffset boolean [WIP] - No field annotation provided 
--- @field chargeParticles ParticleSystem [WIP] - No field annotation provided 
--- @field attackDelay number [WIP] - No field annotation provided 
--- @field projectileSpeed number [WIP] - No field annotation provided 
--- @field amountOfProjectiles integer [WIP] - No field annotation provided 
--- @field waitAfterAttack number [WIP] - No field annotation provided 
