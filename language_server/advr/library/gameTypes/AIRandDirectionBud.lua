...
--- @class AIRandDirectionBud
--- @field amountToShoot integer [WIP] - No field annotation provided 
--- @field shootInterval number [WIP] - No field annotation provided 
--- @field shootProjectile GameObject [WIP] - No field annotation provided 
--- @field unitCircleRadius number [WIP] - No field annotation provided 
--- @field shootOffset Vector3 [WIP] - No field annotation provided 
--- @field timeBetweenSpawnAndShoot number [WIP] - No field annotation provided 
--- @field timeToGrow number [WIP] - No field annotation provided 
--- @field shootSpeed number [WIP] - No field annotation provided 
--- @field delayBetweenSingleProjectileShoot number [WIP] - No field annotation provided 
--- @field doAnimation boolean [WIP] - No field annotation provided 
--- @field shootParticles ParticleSystem [WIP] - No field annotation provided 
--- @field chargeParticles ParticleSystem [WIP] - No field annotation provided 
--- @field growSound ADSoundEffect [WIP] - No field annotation provided 
--- @field shootSound ADSoundEffect [WIP] - No field annotation provided 
