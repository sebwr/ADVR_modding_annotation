...
--- @class ItemFood
--- @field livingBase LivingBase [WIP] - No field annotation provided 
--- @field healAmount integer [WIP] - No field annotation provided 
--- @field distanceFromHeadsetToEat number [WIP] - No field annotation provided 
--- @field highlightInfoSprite Sprite [WIP] - No field annotation provided 
